...
def train_timeseries_models(
    ...
    def arima_prediction(train_set, valid_set):
        ...
        # model = auto_arima(training, start_p=0, start_q=0, max_p=3, max_q=3, start_P=0, max_P=2, max_Q=2,
        #                    seasonal=True, d=1, D=1, trace=True, error_action="ignore", maxiter=500,
        #                    max_order=10, suppress_warnings=True, stepwise=True)
        # model.fit(training)
